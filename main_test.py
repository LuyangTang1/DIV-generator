...
filenames = [pic['filename'] for pic in via_img_metadata.values()]

# Store all boxes' shapes in all images
shapes = [pic['regions'] for pic in via_img_metadata.values()]

# Save shape attributes for each image in a dictionary
# key: image name
# value: (LIST TYPE) A list contains all boxes dictionary with
#        box type(name), x, y, width and height
shape_attributes = {}
